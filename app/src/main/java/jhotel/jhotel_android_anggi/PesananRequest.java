...
public class PesananRequest extends StringRequest {
    private static final String BuatPesanan_URL = "http://192.168.1.103:8080/bookpesanan";
    private Map<String, String> params;

    public PesananRequest(String jumlah_hari, String id_customer, String id_hotel, String nomor_kamar,
